                ...
                <Portal>
                    ...
                    <Dialog.Positioner>
                        <Dialog.Content>
                            ...
                            <Dialog.Body>
                                <Text>
                                    Is this ban for someone with a previous ban?
                                </Text>
                            </Dialog.Body>
                            <Dialog.Footer>
                                <Link to="/create/bannedPerson" ><Button variant="outline">No</Button></Link>
                                <Link to="/create/ban" ><Button colorPalette="current">Yes</Button></Link>
                            </Dialog.Footer>
                        </Dialog.Content>
                    </Dialog.Positioner>
                </Portal>
