import { Button, DataList, HStack, Text, VStack } from "@chakra-ui/react";
...
export type ComponentBanDetailsProps = {
    bans: Ban[] | undefined;
    userRole: Role;
    onHandleEditBanDetailDialogOpen: (ban: Ban) => void;
};

const ComponentBanDetails = ({ bans, userRole, onHandleEditBanDetailDialogOpen }: ComponentBanDetailsProps) => {
...
export default ComponentBanDetails;