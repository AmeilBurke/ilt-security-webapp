...
const PendingBannedPersonCard = ({
  imagePath,
  name,
  createdBy,
  startDate,
  reason,
}: PendingBannedPersonCardProps) => {
  return (
    <VStack h="100%" align="flex-start" gap={2}>
      <Image w="full" aspectRatio={1} objectFit="cover" src={imagePath} />
      <VStack w="full" alignItems="flex-start" gap={1} fontSize="small" color="gray.500">
        ...
        <Text textTransform="capitalize">Reason given: {reason}</Text>
      </VStack>
    </VStack>
  );
};
